...
# Recap of intro course

???

I'm going to try something a little bit different today, and run through the 
...
<br>
.center[__NO IMPACT ON RISK OF BIAS__]
...
# Issue: Assignment vs adherence

---

class: inverse, center, middle

# Issue: Applying at scale
---
...
# Include questions slide at some point!
...
# Some example questions to reinforce learning

<!-- TODO Do this! -->

__Need to put these in document they can download! + Build answer slides!__

I'm looking at a RCT that examined children but I'm interested in adults only, is this a risk of bias problem?

How do I apply ROb2 at scale?

Can I add a domain to handle COI concerns?

What should I do with my risk fo bias assessments once I have completed them?

What resources exist to support me in completing risk of bias assessments?
