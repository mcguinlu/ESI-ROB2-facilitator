...
Presenting in the context of the original tool allows you to bring along anyone who has used the original version and provide a brief history lesson for anyone who hasn't.

Might not want to include this bt
...
__Reminder:__ the possible responses: .g[‘__Yes__’], .g[‘__Probably yes__’], .r[‘__Probably no__’], .r[‘__No__’], ‘No information’
...
Many users simply perform the assessments and bury the results
...
New methods including paired forest plots are now being implemented in `robvis`
