...
Important, as risk of bias may __not  beconstant__ across a study
...
Other scales (Cochrane RoB, Jadad) do not perform better on inter-rater relaiability
...
New methods including __paired forest plots__ are now being implemented in `robvis`
